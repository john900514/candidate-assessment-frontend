    ...
    <div class="drawer drawer-end">
        ...
        <div class="drawer-side fixed" :class="showSidebar ? 'z-50 h-screen' : ''">
            ...
            <ul class="menu p-4 overflow-y-auto w-screen sm:w-96 bg-slightly-transparent-black text-base-content">
                ...
                <li><a class="uppercase font-bold text-xl hover:text-secondary" href="/amenities">Amenities</a></li>
            ...
            <div class="flex justify-between h-16 md:h-18">
                ...
                <div class="flex items-center justify-end flex-1 px-2 sm:justify-center lg:ml-6 lg:justify-end">
                    <div class="hidden md:flex lg:ml-6 xl:ml-8 lg:space-x-8" data-turbo="false">
                        ...
                        <a class="border-transparent text-white inline-flex items-center px-1 pt-1 border-b-2 text-sm font-serif font-normal uppercase tracking-wide" href="/offers"><i class="lar la-user text-xl mr-2 text-secondary font-bold"></i> Current Offers</a>
                        ...
                        <a class="border-transparent text-white inline-flex items-center px-1 pt-1 border-b-2 text-sm font-serif font-normal uppercase tracking-wide" href="/locations"><i class="lar la-map-marker text-xl mr-2 text-secondary font-bold"></i> Locations</a>
